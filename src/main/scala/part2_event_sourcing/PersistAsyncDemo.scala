...
object PersistAsyncDemo extends App {
  ...
  class CriticalStreamProcessor(eventAggregator: ActorRef) extends PersistentActor with ActorLogging {
    ...
    override def receiveCommand: Receive = {
      case Command(contents) =>
        ...
        val processedContents = contents + "_proccessed"
  ...
  val streamProcessor = system.actorOf(CriticalStreamProcessor.props(eventAggregator))
  ...
  /*
    ...
    - performance: high-throughput enviroments
