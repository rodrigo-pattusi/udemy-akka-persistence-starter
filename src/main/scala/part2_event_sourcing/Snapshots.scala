  ...
  class Chat(owner: String, contact: String) extends PersistentActor with ActorLogging {
    ...
    override def receiveCommand: Receive = {
      ...
      case SaveSnapshotSuccess(metadata) =>
        log.info(s"saving succeded: $metadata")
...
//  }
  ...
  /*
    ...
    - if you save snapshot, handle the SnapshotOffer message in receiveRecover
    - (optional, but best practice) handle SavsSnapshotSuccess and SaveSnapshotFailure in receiveCommand
